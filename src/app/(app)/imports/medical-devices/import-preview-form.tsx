...
export function ImportPreviewForm({ q, sourceFile, duplicateOnly, sourceFiles }: ImportPreviewFormProps) {
  return (
    <form className="grid gap-3 rounded border border-line bg-white p-4 shadow-panel md:grid-cols-[1fr_220px_auto_auto] md:items-end">
      ...
      <label className="flex h-11 items-center gap-2 rounded border border-line px-3 text-sm font-semibold text-muted">
